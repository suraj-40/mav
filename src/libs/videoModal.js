  ...
  function playVideos(e) {
    ...
    if (url.includes("youtube") || url.includes("youtu")) {
      ...
      if (match && match[1]) {
        ...
        const embedUrl = `https://www.youtube.com/embed/${videoId}?autoplay=1&rel=0&mute=1`;

        wrapper.innerHTML = `
          ${startModal}
          <iframe width="560" height="315" title="YouTube Video" src="${embedUrl}" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          ${finishModal}
        `;
      }
      ...
      if (match) {
        wrapper.innerHTML = `
          ${startModal}
          <iframe title="Vimeo" src="https://player.vimeo.com/video/${match[2]}?autoplay=1&loop=1" width="640" height="360" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
          ${finishModal}
        `;
      } else {
      ...
      wrapper.innerHTML = `
        ${startModal}
        <video controls loop playsinline autoplay>
