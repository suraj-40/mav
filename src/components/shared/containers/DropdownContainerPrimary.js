...
const DropdownContainerPrimary = ({ children }) => {
  return (
    <div className="shadow-lg  rounded-xl bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 transform transition-all duration-200 hover:shadow-xl">
      {children}
    </div>
  );
};
