...
import img21 from "@/assets/images/life-skills/08. Dhanur Vidya/1.png";
...
const dhanurData = {
  ...
  alignment_info: {
    ...
    description:
      "Dhanur Vidya (Archery) integrates physical discipline with focused concentration, supporting NEP 2020's emphasis on sports-integrated learning and the development of cognitive and psychomotor skills.",
    icon: "🏹"
  },
  description:
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <div className="relative aspect-[4/3]">
                <Image
                  src={img22}
                  alt="Concentration and Patience"
                  className="w-full h-full object-cover"
                  priority
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
          ...
          <div className="relative bg-white rounded-xl p-8 shadow-lg border border-gray-100 overflow-hidden">
            ...
            <div className="flex items-center gap-4 mb-6">
              <div className="w-12 h-12 flex items-center justify-center rounded-full bg-gradient-to-r from-[#FF5722] to-orange-600 text-white text-2xl shadow-md flex-shrink-0">
                {dhanurData.alignment_info.icon}
              </div>
