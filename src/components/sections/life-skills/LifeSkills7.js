...
import img11 from "@/assets/images/life-skills/07. Bhagavad Gita/1.png";
...
const gitaData = {
  ...
  alignment_info: {
    ...
    description:
      "Bhagavad Gita's teachings on self-discipline, ethics, and mental resilience align perfectly with NEP 2020's focus on value-based education and character building, fostering a well-rounded and grounded student community.",
    icon: "📖"
  },
  description:
