...
const samskritaData = {
  ...
  samskrita_description:
    "Samskrita Siddhi at Agasthya Vidyanikethan introduces students to Sanskrit, fostering a connection to India's cultural and linguistic heritage. This program enhances cognitive flexibility and supports NEP 2020's goal of promoting multidisciplinary and culturally rooted education."
};
