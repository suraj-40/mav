...
const chadurangaData = {
  ...
  chaduranga_description:
    "Chaduranga Siddhi at Agasthya Vidyanikethan engages students in strategic games like chess to enhance cognitive abilities. This program fosters critical thinking, problem-solving, and decision-making, aligning with NEP 2020's goal of developing analytical and intellectual skills."
};
