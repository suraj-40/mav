...
{!isAbout && !isAboutDark && (
  ...
  >
    ...
    <motion.div 
      className="absolute top-0 right-0 w-32 h-32 rounded-full bg-blue-100 opacity-50 blur-2xl -z-10"
    ...
    <motion.div 
      className="absolute bottom-0 left-0 w-24 h-24 rounded-full bg-yellow-100 opacity-50 blur-2xl -z-10"
      initial={{ scale: 0, x: -20, y: 20 }}
      animate={{ scale: 1, x: 0, y: 0 }}
    ...
    >
      <div className="relative w-20 h-20 mx-auto">
        <div className="absolute w-full h-full rounded-full border-4 border-[#FF5722] opacity-20 animate-ping" />
        <div className="absolute inset-2 rounded-full bg-gradient-to-r from-[#FF5722] to-orange-400 shadow-lg shadow-orange-200" />
        <div className="absolute w-full h-full animate-spin-slow" style={{ animationDuration: '8s' }}>
          <div className="absolute w-5 h-5 bg-[#FF5722] rounded-full shadow-md top-0 left-1/2 transform -translate-x-1/2" />
        </div>
        <div className="absolute w-full h-full animate-spin-slow" style={{ animationDuration: '6s', animationDirection: 'reverse' }}>
          <div className="absolute w-4 h-4 bg-[#FF5722] rounded-full shadow-md bottom-1 right-1" />
        </div>
    ...
    >
      ...
      >
        <button className="px-8 py-3 bg-gradient-to-r from-[#FF5722] to-orange-600 text-white rounded-full shadow-lg shadow-orange-200 hover:shadow-orange-300 transition-all duration-300 transform hover:-translate-y-1 font-medium">
          Get Started
        </button>
        <button className="px-8 py-3 bg-white text-gray-700 border border-gray-200 rounded-full shadow-sm hover:shadow-md transition-all duration-300 transform hover:-translate-y-1 font-medium">
          Learn More
        </button>
      </motion.div> */}
    </motion.div>
            ...
            <div className="flex justify-between gap-2 whitespace-nowrap" data-aos="fade-up">
              {tabButtons.map(({ name, icon }, idx) => (
                ...
                >
                  ...
                  >
                    <span className={currentIdx === idx ? "text-white" : "text-[#FF5722]"}>
                      {icon}
                    </span>
                    {name}
                  </button>
        ...
        <div className="max-w-6xl mx-auto mt-8">
          ...
          <div className="block md:hidden">
            ...
            <div className="flex justify-between mt-6 mb-2">
              <button 
                onClick={() => handleTabClick(currentIdx > 0 ? currentIdx - 1 : tabButtons.length - 1)}
