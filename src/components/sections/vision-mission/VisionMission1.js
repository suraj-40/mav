...
const nepData = {
  ...
  nep_alignment: [
    ...
    },
    {
      ...
      description:
        "The policy places a strong emphasis on instilling values and ethics in students. At Agasthya Vidyanikethan, we share this commitment and ensure that values such as integrity, empathy, and responsibility are an integral part of the educational experience.",
      icon: "❤️"
    },
    {
