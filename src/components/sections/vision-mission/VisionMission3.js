...
const qualityData = [
  {
    ...
    description:
      "At Agasthya Vidyanikethan, we take immense pride in our exceptional team of educators who serve as the bedrock of your child's educational journey. We believe that quality learning begins with quality educators, and that's precisely what you'll find within our distinguished faculty.",
    icon: "🌟"
  },
  {
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h1 className="text-3xl md:text-4xl font-bold text-gray-800">
            Quality Education at Agasthya Vidyanikethan
          </h1>
