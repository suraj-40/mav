...
const lifelongSuccessData = [
  {
    ...
    description:
      "At Agasthya Vidyanikethan, we understand that a child's journey through education is not just about academics; it's about shaping a well-rounded individual ready to conquer life's challenges. Our commitment to holistic development ensures that your child is prepared for a successful and fulfilling life, both academically and personally.",
    icon: "🌟"
  },
  {
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h1 className="text-3xl md:text-4xl font-bold text-gray-800">
            Lifelong Success at Agasthya Vidyanikethan
          </h1>
