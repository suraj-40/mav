      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h1 className="text-3xl md:text-4xl font-bold text-gray-800">
            Technology at Agasthya Vidyanikethan
          </h1>
