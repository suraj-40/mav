      ...
      >
        <div className="md:col-span-7 flex flex-col justify-center">
          ...
          <p className="text-lg text-gray-700 leading-relaxed max-w-xl mb-4 text-justify">
            Agasthya Vidyanikethan is committed to nurturing young minds through quality education, strong values, and holistic development. With a student-centric approach and dedicated educators, we foster an environment where learners develop confidence, curiosity, and a passion for knowledge.
          </p>
          <p className="text-lg text-gray-700 leading-relaxed max-w-xl text-justify">
            Our institution encourages creativity, critical thinking, and intellectual growth. We provide a safe, inclusive, and inspiring atmosphere where every child is supported to realize their full potential. At Agasthya Vidyanikethan, we strive to shape responsible citizens and future leaders who contribute positively to society.
          </p>
        </div>
