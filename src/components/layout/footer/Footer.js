            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start space-x-1">
                ...
                <div className="flex flex-col">
                  ...
                  <a
                    className="block hover:text-avorange transition-colors duration-300"
                    href="mailto:info@av.school"
                  >
                    info@av.school
                  </a>
                  <a
            ...
            <ul className="space-y-4">
              <li className="flex items-start space-x-1">
                ...
                <a
                  ...
                  className=" hover:text-avorange transition-colors duration-300"
                >
                  170/3, 6th Block, Off. 100 Feet Road, Sir M. V. Layout, Ullalu Upanagar, BENGALURU – 560110.
                </a>
              </li>
            </ul>
          </div>
