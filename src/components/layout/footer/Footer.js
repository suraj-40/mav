        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div data-aos="fade-up">
            ...
            <p className="text-[#000008] mb-6 text-lg font-medium">
              ...
              <span className="text-school-orange text-2xl" style={{fontFamily: 'Samarkan, cursive',}}>Agasthya Vidyanikethan</span>
            </p>
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/@AgasthyaVidyaniketan/" className="text-black hover:text-school-orange transition-colors duration-300">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z" />
                </svg>
              </a>
              <a href="https://www.instagram.com/agasthyavidyanikethan/" className="text-black hover:text-school-orange transition-colors duration-300">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://in.linkedin.com/company/agasthya-vidyanikethan" className="text-black hover:text-school-orange transition-colors duration-300">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
