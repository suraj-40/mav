      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-30px">
            ...
            <TiltWrapper>
              <div className="relative overflow-hidden z-0 flex flex-col ">
                ...
                <div className="bg-gray-50 rounded-lg mt-5 p-6 shadow-inner border border-gray-200">
                  ...
                  &quot;At Agasthya Vidyanikethan, we prepare children not just
                  for exams, but for life itself.&quot;
                  </h3>
                  <p className="text-contentColor text-sm md:text-base leading-relaxed">
                  We believe learning should be clear, real, and lifelong.
                  It&apos;s not just about scoring well in exams, but about
                  building the ability to think independently, ask the right
                  questions, and approach challenges with confidence. We
                  encourage each child to explore through active learning while
                  developing their self-confidence. Our education prepares
                  students for life&apos;s challenges by providing them with
                  essential knowledge, practical skills, and a clear sense of
                  personal identity.
                  </p>
          ...
          <div data-aos="fade-up" className="2xl:ml-65px">
            ...
            <p className="text-sm md:text-base leading-7 text-contentColor dark:text-contentColor-dark">
              Mrs. Nagarathna Aradhya as the secretary of the trust, is the
              primordial energy actively focused on implementing on the ground,
              the vision and mission of the trust to achieve its stated
              objectives. She has been instrumental in leading a team of 125+
              members and guiding them in shaping the young minds of Agasthya
              Vidyanikethan.
            </p>
            <br />
            {/* <p className="text-sm md:text-base leading-7 text-contentColor dark:text-contentColor-dark">
            ...
            <p className="text-sm md:text-base leading-7 text-contentColor dark:text-contentColor-dark">
              She has an amazing academic and professional track record, having
              served in both the corporate and academic worlds. As a Computer
              Science engineer herself, she has been instrumental in leveraging
              technology for an efficient schooling experience. As the
              torchbearer, she leads her team by example, which is reflected in
              the spectacular academic performance of Agasthya Vidyanikethan
              over the years.
            </p>
            <br />
            <p className="text-sm md:text-base leading-7 text-contentColor dark:text-contentColor-dark">
              As the secretary of the trust over the years, she has been
              instrumental in providing crucial administrative support,
              organizing meetings, preparing agendas, and ensuring all necessary
              documentation of the trust activities are in order. Beyond
              academics, she has been extremely effective in maintaining the
              minutes of meetings, financial records, legal documents, and other
              important correspondence. She has provided her valuable support to
              the chairperson of the trust, enabling and ensuring that their
              leadership has propelled Agasthya Vidyanikethan as the most
              sought-after educational institution in the vicinity.
            </p>
            <br />
            <p className="text-sm md:text-base leading-7 text-contentColor dark:text-contentColor-dark">
              Under her able leadership, our children have been able to not only
              excel academically but also have won various awards, titles, and
              rewards in &apos;Prathibha Karanji&apos;, &apos;SOF
              Olympiad&apos;, and many other district, state, and national level
              competitions. She has also been awarded the &apos;SHIKSHA RATNA
              Award&apos; in the year 2022 for her excellent leadership
              qualities.
            </p>
            <br />
            {/* <p className="text-sm md:text-base leading-7 text-contentColor dark:text-contentColor-dark">
