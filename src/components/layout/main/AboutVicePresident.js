      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-30px">
              ...
              <div className="relative overflow-hidden z-0 flex flex-col ">
                ...
                <div className="bg-gray-50 rounded-lg mt-5 p-6 shadow-inner border border-gray-200">
                  <h3 className="text-sm md:text-base text-justify text-avorange font-semibold  mb-2">
                    &quot;Every child&apos;s future is the heart of our mission
                    at Agasthya Vidyanikethan.&quot;
                  </h3>
                  <p className="text-contentColor text-sm md:text-base leading-relaxed">
                    A great school doesn&apos;t just teach — it inspires,
                    encourages, and builds a path for lifelong growth. At
                    Agasthya Vidyanikethan, we have created an environment where
                    learning deepens each day, supported by thoughtful planning
                    and the right resources. Our vision is simple yet powerful:
                    every child deserves an education that prepares them not
                    only for exams but for life. Here, we place every
                    student&apos;s future at the center of our efforts, ensuring
                    they leave our care not just smarter, but stronger, more
                    capable, and ready for tomorrow.
                  </p>
          ...
          <div data-aos="fade-up" className="2xl:ml-65px">
            ...
            <p className="text-sm md:text-base leading-7 text-contentColor dark:text-contentColor-dark">
              As the Vice President of the trust, Mr. Thejaswi Aradhya&apos;s
              strategic planning & policy development skills have significantly
              enhanced the trust&apos;s educational offerings & expanded its
              reach. His adept resource management skills align with the
              trust&apos;s objectives to maintain high educational standards &
            ...
            <p className="text-sm md:text-base leading-7 text-contentColor dark:text-contentColor-dark">
              Mr. Thejaswi Aradhya also excels in budget management,
              contributing positively to the trust&apos;s financial health &
              accountability. His leadership in developing new revenue streams
              has accelerated the manifestation of the trust&apos;s goals. This
              effort of his not only supports ongoing trust activities, but also
              promotes continuous improvement & effectiveness, ensuring that the
              trust remains a dynamic force in education and community
              development.
            </p>
            <br />
            {/* <p className="text-sm md:text-base leading-7 text-contentColor dark:text-contentColor-dark">
            ...
            <p className="text-sm md:text-base leading-7 text-contentColor dark:text-contentColor-dark">
              He is a visionary social entrepreneur, and also serves as the
              Founder-Director of an investment & real estate development firm
              dedicated to transforming underutilized areas into valuable,
              sustainable properties. His innovative approach towards
              transforming underdeveloped areas into valuable assets has offered
              long-term benefits to both individual families & communities
              alike. With over three decades of experience, Mr. Thejaswi Aradhya
              has been instrumental in driving expansion, innovation,
              profitability, & community development, focusing on sustainability
              and enhancing the quality of life.
            </p>
            <br />
            <p className="text-sm md:text-base leading-7 text-contentColor dark:text-contentColor-dark">
              Dedicated to serving underprivileged communities, Mr. Thejaswi
              Aradhya is actively involved with various NGOs & organizations
              that serve the needy & uphold humanitarian values. His commitment
              is evident in his efforts to secure long-term educational resource
              & support improvements for those in need, thus fostering
              substantial & lasting positive change.
            </p>
