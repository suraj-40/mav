...
import { FaBell, FaChevronDown, FaRegNewspaper, FaUser, FaUserPlus } from "react-icons/fa"; // Importing notification bell icon
import { AiOutlineLogout, AiOutlineUser, AiOutlineUserAdd, AiOutlineUsergroupAdd } from "react-icons/ai";
import { MdOutlineAssignment, MdOutlineLogout, MdOutlineQuiz, MdOutlineSubscriptions } from "react-icons/md";
    ...
    jqueryScript.onload = () => {
      ...
      sdkScript.onload = () => {
        ...
        if (typeof window.addStyles === "function") {
          window.addStyles(`body{ font-family: 'Intro' !important;} button{ margin-top:30px;}`);
        }
