...
export const metadata = {
  ...
  description: "Get in touch with Agasthya Vidyanikethan . Contact us for admissions, inquiries, campus visits, or general information. We're here to help with your educational journey.",
  alternates: {
