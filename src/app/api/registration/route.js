    ...
    <div style="font-family: Arial, sans-serif; color: #333; padding: 5px; border-radius: 8px; margin: auto;">
     <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
      ...
      <p style="text-align: justify;">
        Thank you for confirming your campus visit to <strong>Agasthya Vidyanikethan</strong> as a potential learning home for <strong>${childName}</strong>. 
      ...
      <p style="text-align: justify;">
        At Agasthya Vidyanikethan, we are dedicated to empowering every student with the knowledge, skills, and values needed to thrive in a future-focused world. 
  ...
  try {
    if (parentEmail) {
      ...
      const info1 = await transporter.sendMail({
        from: '"Agasthya Vidyanikethan" <info@av.school>', // updated to school email
        to: parentEmail,
